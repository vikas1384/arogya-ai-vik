          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="w-5 h-5 text-health-600 mt-0.5 mr-2 flex-shrink-0" />
                <span className="text-gray-600 dark:text-gray-300">Cyber City, Gurugram, Haryana 122002, India</span>
              </li>
              <li className="flex items-center">
                <Phone className="w-5 h-5 text-health-600 mr-2 flex-shrink-0" />
                <span className="text-gray-600 dark:text-gray-300">+91 (800) 123-4567</span>
              </li>
              <li className="flex items-center">
